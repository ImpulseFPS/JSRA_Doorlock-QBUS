...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
 Citizen.SetTimeout(1000, function()
	TriggerEvent('QBCore:GetObject', function(obj) QBCore = obj end)
	 Citizen.Wait(250)
	 QBCore.Functions.TriggerCallback("JSRA-Doorlock:server:get:config", function(config)
		Config = config
	end)
	Citizen.Wait(150)
	LoggedIn = true
...
RegisterNetEvent('JSRA-Doorlock:client:change:door:looks')
AddEventHandler('JSRA-Doorlock:client:change:door:looks', function(Door, Type)
...
RegisterNetEvent('JSRA-Doorlock:server:reset:door:looks')
...
RegisterNetEvent('JSRA-Doorlock:client:setState')
AddEventHandler('JSRA-Doorlock:client:setState', function(Door, state)
...
function SetDoorLock(Door, key)
 ...
 SetTimeout(1000, function()
   ...
   TriggerServerEvent('JSRA-Doorlock:server:updateState', key, Door['Locked'])
 end)
end
...
function ChangeDoorLooks(Door, Type)
	TriggerServerEvent('JSRA-Doorlock:server:change:door:looks', Door, Type)
end